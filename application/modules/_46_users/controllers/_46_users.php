...
class _46_users extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '_46_users/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . '_46_users/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . '_46_users/index.html';
            $config['first_url'] = base_url() . '_46_users/index.html';
        }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2021-02-13 18:15:02 */
/* http://harviacode.com */
