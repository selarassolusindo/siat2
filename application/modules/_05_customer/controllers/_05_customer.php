...
class _05_customer extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '_05_customer?q=' . urlencode($q);
            $config['first_url'] = base_url() . '_05_customer?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . '_05_customer';
            $config['first_url'] = base_url() . '_05_customer';
        }
