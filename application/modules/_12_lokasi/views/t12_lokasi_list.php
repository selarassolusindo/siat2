    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php
				echo anchor(site_url('_12_lokasi/read/'.$_12_lokasi->idservice),'Read');
				echo ' | ';
				echo anchor(site_url('_12_lokasi/update/'.$_12_lokasi->idservice),'Update');
				echo ' | ';
				echo anchor(site_url('_12_lokasi/delete/'.$_12_lokasi->idservice),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
				?>
			</td>
		</tr>
                <?php
