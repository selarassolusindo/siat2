    ...
    <body>
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('_10_service'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('_10_service'); ?>" class="btn btn-secondary">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <table class="table table-bordered" style="margin-bottom: 10px">
			...
			<?php foreach ($_10_service_data as $_10_service) { ?>
            <tr>
