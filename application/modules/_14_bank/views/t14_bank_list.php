    ...
    <body>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                ...
                <?php echo anchor(site_url('_14_bank/create'),'Tambah', 'class="btn btn-primary"'); ?>
                <?php } ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('_14_bank'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('_14_bank'); ?>" class="btn btn-secondary">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <table class="table table-bordered" style="margin-bottom: 10px">
            ...
            <tr>
				...
				//echo ' | ';
                if ($hakAkses['ubah']) {
				echo anchor(site_url('_14_bank/update/'.$_14_bank->idbank),'Ubah');
                if ($hakAkses['hapus']) {
				echo ' | ';
                }
                }
                if ($hakAkses['hapus']) {
				echo anchor(site_url('_14_bank/delete/'.$_14_bank->idbank),'Hapus','onclick="javascript: return confirm(\'Are You Sure ?\')"');
                }
				?>
				</td>
			</tr>
